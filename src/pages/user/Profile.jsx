...
import { User, Clock, CheckCircle, XCircle, Package, AlertCircle } from 'lucide-react';
                  ...
                  >
                    ...
                    <div className="grid md:grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900 font-medium">{claim.found_location}</p>
                      </div>
                    </div>
